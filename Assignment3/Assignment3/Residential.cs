...
namespace Assignment3
{
    abstract class Residential : Facility
    {
        ...
        public int GetContentPopulation(double contentPopulationRatio, int currentPopulation)
        {
        ...
        public int GetHappyPopulation(double happyPopulationRatio, double currentPopulation)
        {
